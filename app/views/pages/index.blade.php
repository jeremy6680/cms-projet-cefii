	    	...
	    	<tr>
			    ...
			    <td>
			    	@if(Auth::user()->admin == 1)
						...
						<a href="{{ URL::route('admin.pages.edit', $page->id) }}"><span class="fi-pencil icon" title="icon modifier icon" aria-hidden="true"></span></a>
			    	@else
			    ...
			    <td>
			    	...
			    	<a href="{{ URL::route('admin.pages.show', $page->id) }}" target="_blank"><span class="fi-eye icon" title="icon voir icon" aria-hidden="true"></span></a>
			    </td>
	    	</tr>
	    @endforeach
	    </tbody>
